...
public class AuthController {
    ...
    public void handleLogin() {
        ...
        try {
            ...
            // NOTE: If you implemented the UserSession bean, inject it and save the user here!
    ...
    private Stage getCurrentStage() {
        if (loginButton != null)   return (Stage) loginButton.getScene().getWindow();
        if (registerButton != null) return (Stage) registerButton.getScene().getWindow();
